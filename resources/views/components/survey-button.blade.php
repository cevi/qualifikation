...
<div class="col-sm-4" style="margin-bottom: 10px;">
    ...
    @else
        <span title="Bitte zuerst auf 'Qualifikationen erstellen' klicken" style="display: inline-block; cursor: not-allowed;">
            <a href="javascript:;" class="focus:outline-hidden text-white bg-purple-700 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 {{ $btnClass }}" style="pointer-events: none; opacity: 0.5; text-decoration: none; display: inline-block;" role="button" aria-disabled="true">{{ $text }}</a>
        </span>
    @endif
</div>
